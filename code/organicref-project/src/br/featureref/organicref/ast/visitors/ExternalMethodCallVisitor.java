...
/**
 * Recieves a MethodDeclaration as input and returns all external methods call made by the input method
 *  
 */
public class ExternalMethodCallVisitor extends CollectorVisitor<IMethodBinding> {
	...
	public ExternalMethodCallVisitor(AbstractTypeDeclaration declaringType) {
