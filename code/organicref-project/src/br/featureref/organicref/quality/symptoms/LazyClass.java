...
public class LazyClass extends  TypeSymptom
{
  private int numOfFields;
  private int numOfMethods;
  private int numStatements;

  public LazyClass(Type type, int numOfFields, int numOfMethods, int numStatements) {
    super(type);
  ...
  public String toString() {
    return "LazyClass [numOfFields=" + numOfFields + ", numOfMethods=" + numOfMethods + ", numStatements="
        + numStatements + "]";
  }
}
